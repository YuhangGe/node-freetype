...
function getFirstCharIndex(glyphs) {
    var minGlyph = _.min(glyphs, function (glyph) {
...
function getLastCharIndex(glyphs) {
    var maxGlyph = _.max(glyphs, 'unicode');
    if (maxGlyph) {
...
function createOS2Table(font) {
    ...
    buf.writeInt16(os2.xAvgCharWidth); // xAvgCharWidth
    buf.writeUint16(os2.usWeightClass); // usWeightClass
    buf.writeUint16(os2.usWidthClass); // usWidthClass
    ...
    buf.writeInt16(os2.sFamilyClass); // sFamilyClass
    ...
    buf.writeUint16(getFirstCharIndex(glyphs)); // usFirstCharIndex
    buf.writeUint16(getLastCharIndex(glyphs)); // usLastCharIndex
    ...
    buf.writeUint32(os2.ulCodePageRange1); // ulCodePageRange1, Latin 1
    buf.writeUint32(os2.ulCodePageRange2); // ulCodePageRange2
