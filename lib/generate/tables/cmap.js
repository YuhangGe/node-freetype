...
function getSegments(font, bound) {
  ...
  _.forEach(font._glyphs, function (glyph) {
...
function createCMapTable(font) {
  ...
  var hasGLyphsOver2Bytes = _.find(font._glyphs, function(glyph) {
  ...
  var subTable0 = createSubTable0(font._glyphs); // subtable 0
  var subTable4 = createSubTable4(font._glyphs, segments2bytes); // subtable 4
