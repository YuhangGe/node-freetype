...
ByteBuffer.prototype.writeInt16 = function (value, littleEndian) {
    var off = this.offset + this.start;
    this.buffer[littleEndian ? 'writeInt16LE' : 'writeInt16BE']((value < 0) ? 0xFFFF + value + 1 : value, off);
    this.offset += 2;
};

ByteBuffer.prototype.writeUint16 = function(value, littleEndian) {
    var off = this.offset + this.start;
    this.buffer[littleEndian ? 'writeUInt16LE' : 'writeUInt16BE'](value, off);
    this.offset += 2;
};

ByteBuffer.prototype.writeInt32 = function (value, littleEndian) {
    var off = this.offset + this.start;
    this.buffer[littleEndian ? 'writeInt32LE' : 'writeInt32BE']((value < 0) ? 0xFFFFFFFF + value + 1 : value, off);
    this.offset += 4;
};

ByteBuffer.prototype.writeUint32 = function(value, littleEndian) {
    var off = this.offset + this.start;
    this.buffer[littleEndian ? 'writeUInt32LE' : 'writeUInt32BE'](value, off);
    this.offset += 4;
};
