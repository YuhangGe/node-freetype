...
#
REQUIRES_PRIVATE   := libpng, harfbuzz >= 0.9.19
LIBS_PRIVATE       := -lz -lbz2
LIBS_CONFIG        := -lfreetype -lz -lbz2 -L/usr/local/Cellar/libpng/1.6.13/lib -lpng16 -L/usr/local/Cellar/harfbuzz/0.9.35_1/lib -lharfbuzz
LIBSSTATIC_CONFIG  := -lfreetype -lz -lbz2 -L/usr/local/Cellar/libpng/1.6.13/lib -lpng16 -lz -L/usr/local/Cellar/harfbuzz/0.9.35_1/lib -lharfbuzz
build_libtool_libs := 
ft_version         := 17.2.11
